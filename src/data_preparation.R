...
a549_1 <- read.csv('Predicted/SGNex_A549_directRNA_replicate5_run1_predictions.csv')
a549_2 <- read.csv('Predicted/SGNex_A549_directRNA_replicate6_run1_predictions.csv')
hct116_1 <- read.csv('Predicted/SGNex_Hct116_directRNA_replicate3_run1_predictions.csv')
hct116_2 <- read.csv('Predicted/SGNex_Hct116_directRNA_replicate3_run4_predictions.csv')
hct116_3 <- read.csv('Predicted/SGNex_Hct116_directRNA_replicate4_run3_predictions.csv')
hepg2_1 <- read.csv('Predicted/SGNex_HepG2_directRNA_replicate5_run2_predictions.csv')
hepg2_2 <- read.csv('Predicted/SGNex_HepG2_directRNA_replicate6_run1_predictions.csv')
k562_1 <- read.csv('Predicted/SGNex_K562_directRNA_replicate4_run1_predictions.csv')
k562_2 <- read.csv('Predicted/SGNex_K562_directRNA_replicate5_run1_predictions.csv')
k562_3 <- read.csv('Predicted/SGNex_K562_directRNA_replicate6_run1_predictions.csv')
mcf7_1 <- read.csv('Predicted/SGNex_MCF7_directRNA_replicate3_run1_predictions.csv')
mcf7_2 <- read.csv('Predicted/SGNex_MCF7_directRNA_replicate4_run1_predictions.csv')
